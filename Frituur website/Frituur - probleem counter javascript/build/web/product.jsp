    ...
    <body>
        ...
        function OnClickButton()
        {
            if(typeof(Storage) !== "undefined")
            {
                ...
                document.getElementById("aantal").value =  sessionStorage.clickcount;
        ...
        <%
          String value = request.getParameter("aantal");
          if (value != null) {
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                 ...
                 <li>
                     ...
                     <label id="aantal" name="aantal" style="margin-top: 1em"  > <%= count %> </label>
